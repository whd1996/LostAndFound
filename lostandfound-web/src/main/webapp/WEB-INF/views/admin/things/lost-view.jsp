...
<body>    
        ...
        <fieldset style="border:solid 1px #aaa;padding:3px;">
        	...
        	<table style="table-layout:fixed;">
                ...
                <tr>
                    ...
                    <td class="text-rigth" style="width:70px;">丢失地点：</td>
                    <td style="width:150px;">    
                        <input name="lostPlace" id="lostPlace" class="mini-textbox" allowInput="false"/>
                    </td>
                </tr>
                <tr>
                    <td class="text-rigth">丢失时间：</td>
                    <td>    
                        <input name="lostTime" id="lostTime" class="mini-textbox" allowInput="false"/>
                    </td>
    ...
    function setData(data) {
        ...
        $.ajax({
            url: "${path}/admin/lost-query.html",
            type: 'post',
            cache: false,
            ...
            success: function (text) {
                ...
                o.lostTime = mini.formatDate(o.lostTime, "yyyy-MM-dd");
