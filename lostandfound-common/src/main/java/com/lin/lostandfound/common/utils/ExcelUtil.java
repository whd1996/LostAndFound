...
import com.lin.lostandfound.common.exception.ExcelException;
import jxl.Cell;
import jxl.Sheet;
import jxl.Workbook;
...
public class ExcelUtil {
	 ...
	 */
	public static <T> void listToExcel(List<T> list,
			LinkedHashMap<String, String> fieldMap, String sheetName, OutputStream out) throws ExcelException {
	 ...
	 * 即接受简单厲性名，如userName等，又接受带路径的厲性名，如student.department.name等
	 * @param fieldNameSequence带路径的属性名或简单厲性名
	 * @param o 对象
	 * @return 厲性值
	 * @throws Exception
	 */
